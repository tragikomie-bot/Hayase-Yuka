...
"$BT/apksigner" sign --ks signing/qinglan-release.p12 --ks-key-alias qinglan --ks-pass file:signing/password.txt --out output/mailbox-ledger-1.2.0.apk build/aligned.apk
"$BT/apksigner" verify --verbose output/mailbox-ledger-1.2.0.apk
"$BT/zipalign" -c 4 output/mailbox-ledger-1.2.0.apk
